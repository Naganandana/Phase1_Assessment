...
public class WelcomeScreen {
	...
	public static void main(String[] args) {
		...
		File directory = new File("D:\\Nagananda Projects\\Lockers Pvt. Ltd\\");
		...
		do {
			...
			case 1:
				...
				try {
					File file = new File("D:\\Nagananda Projects\\Lockers Pvt. Ltd\\" + filename + ".txt");
			...
			case 3:
				...
				File directory_delete = new File("D:\\Nagananda Projects\\Lockers Pvt. Ltd\\");
				...
				if (flist_delete == null) {
					...
					for (int i = 0; i < flist_delete.length; i++) {
						...
						if (delete_filename.equalsIgnoreCase(filename)) {
							...
							File file = new File(
									"D:\\Nagananda Projects\\Lockers Pvt. Ltd\\" + delete_filename);
							if (file.delete()) {
			...
			case 4:
				...
				File directory_search = new File("D:\\Nagananda Projects\\Lockers Pvt. Ltd\\");
	...
	private static void listOfFiles() {
		...
		File folder = new File("D:\\Nagananda Projects\\Lockers Pvt. Ltd\\");
